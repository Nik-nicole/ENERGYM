...
;
const metadata = {
    title: "HYRO - Transforma Tu Nivel",
    description: "Gimnasio premium con planes flexibles y servicios de clase mundial en Bogotá, Medellín, Barranquilla y Cartagena",
    generator: "v0.app",
    icons: {
        icon: [
            {
